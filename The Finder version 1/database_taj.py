...
Барномаи The Finder барои ҷустуҷӯ кардани
ҳама намуди файлҳо ба Шумо ёрӣ медиҳад.
Барнома соли 2019 аз тарафи барномасоз
Зикрулло Амирӣ сохта шудааст.

Версия:     2.0


Суроғаи электронӣ:  amirymax@gmail.com
                                       amirymax@mail.com     
                                       amirymax@mail.ru
                                     
                  
Саҳифаҳои интернетӣ:  facebook.com\\amirymax
...
def mp3():
   ...
   Label(w3,text='  Номи мусиқиро нависед:  ',
         font='Courier -24 bold',fg='red',bg='sky blue').grid(
   ...
   Button(w3,width=75,height=75,border='0',
          ...
          image=pm,bg='sky blue').grid(
             row=2,column=0,padx=35,columnspan=4)
   
   Label(w3,text=' Кушодан ',font='courier -24 bold',
   ...
   Button(w3,width=75,height=75,border='0',
          command=w3.destroy,image=cl,bg='sky blue').grid(
             ...
             padx=55,columnspan=5)
   
   Label(w3,text=' Пӯшидан ',font='courier -24 bold',
...
def playmp3():
   ...
   if field1.get().lower() in check(m[0]).lower():

      cleanup()
      
      os.startfile(m[0])

      Label(w3,text='Кушода шуд',
            font='Courier -20 bold',fg='red',bg='sky blue').grid(
      ...
      Label(w3,text='Кушодан',font='courier -22',fg='gray',bg='sky blue').grid(
      ...
      for i in m:
         if field1.get().lower() not in check(i).lower():
...
def mp4():
   ...
   Label(w3,text='  Номи видеоро нависед:  ',
         font='Courier -24 bold',fg='red',bg='sky blue').grid(
            row=0,column=0,columnspan=6,pady=5)
...
def playmp4():
   ...
   if field1.get().lower() in check(v[0]).lower():
      ...
      Button(w3,width=75,height=75,text='Кушодан',command=openl,
             image=op,border='0',bg='sky blue').grid(row=7,column=9)
      ...
      for i in v:
         ...
         elif i!='' and field1.get().lower() in check(i).lower():
...
def photo():
   ...
   Label(w3,text='  Номи расмро нависед:  ',
         font='Courier -24 bold',fg='red',bg='sky blue').grid(
            row=0,column=0,columnspan=6,pady=5)
...
def openphoto():
   ...
   la=Label(w3,text=' ', font='courier -20 bold',
            fg='red',bg='sky blue')                     
   if field1.get().lower() in check(a[0]).lower():
...
def doc():
   ...
   Label(w3,text='  Номи ҳуҷҷатро нависед:  ',
         font='Courier -24 bold',fg='red',
         bg='sky blue').grid(
            row=0,column=0,columnspan=6,pady=5)
   ...
   Label(w3,text='Кушодан',font='Courier -22 bold',
         fg='red',bg='sky blue').grid(
      row=3,column=0,padx=30,columnspan=4,)
   ...
   Label(w3,text='Пӯшидан',font='Courier -22 bold',
         fg='red',bg='sky blue').grid(
      row=3,column=2,padx=50,columnspan=5)
...
def opendoc():
   ...
   la=Label(w3,text=' ',
               font='courier -20 bold',fg='red',bg='sky blue')                     
   if field1.get().lower() in check(d[0]).lower():
      ...
      Button(w3,width=75,height=75,
             text='Open',command=openl,
             image=op,border='0',
             bg='sky blue').grid(
                row=7,column=9)
      
      Label(w3,text='Кушодан',font='Courier -22',
...
def ppt():
   ...
   w3.title('  Ҳуҷҷати  Ms PowerPoint   ')
   w3.iconbitmap("icons\\ppt.ico")

   w3.config(bg='sky blue')
   
   lub=Label(w3,text='Hоми ҳуҷҷатро нависед:',
         font='Courier -24 bold', fg='red',bg='sky blue')
...
def openppt():
   ...
   la=Label(w3,text=' ',
               font='courier -20 bold',fg='red',bg='sky blue')                     
   if field1.get().lower() in check(p[0]).lower():
...
def pdf():
   ...
   Label(w3,text='Номи ҳуҷҷати pdf-ро нависед:',
         font='Courier -24 bold',bg='sky blue',
...
def openpdf():
   ...
   la=Label(w3,text=' ',font='courier -20 bold',
            fg='red',bg='sky blue')                     
   if field1.get().lower() in check(pd[0]).lower():
      ...
      Label(w3,text='Кушодан',font='Batang -22',
            fg='gray',bg='sky blue').grid(
               row=8,column=9,padx=20)
...
def fold():
   ...
   labl=Label(w3,text='  Номи ҷувздонро нависед:  ',
   ...
   lax=Label(w3,text='Кушодан',font='courier -22 bold',
             fg='red',bg='sky blue')
   ...
   labb=Label(w3,text='Пӯшидан',font='courier -22 bold',
              fg='red',bg='sky blue')
...
def openfold():
   ...
   la=Label(w3,text=' ',font='courier -20 bold',
            fg='red',bg='sky blue')                     
   if field1.get().lower() in check(f[0]).lower():
...
def general():
   ...
   Label(w3,text='  Чиро ҷустуҷӯ доред?  ',
         font='courier -24 bold',fg='red',bg='sky blue').grid(
   ...
   Label(w3,text='Ҷустуҷӯ',font='batang -22 bold',
         fg='red',bg='sky blue').grid(
      row=3,column=0,columnspan=4,padx=30)
...
def generallist():
   ...
   for i in g:
      if field1.get().lower() in check(i[:-1]).lower():
         a.append(i)
   ...
   for i in a:
      if field1.get().lower() in check(i).lower():
         l.insert(END,i)
...
def ex():
    ...
    m=messagebox.askquestion('Баромад','Шумо дар ҳақиқат мехоҳед, ки барнома пӯшида шавад?')
...
def info():
   ...
   messagebox.showinfo('Маълумот',s)
